...
SCH_SET_ZONE_SCHED = _SCH_ENTITY_ID.extend({vol.Required(ATTR_SCHEDULE): cv.string})
...
SCH_SET_DHW_SCHED = _SCH_ENTITY_ID.extend({vol.Required(ATTR_SCHEDULE): cv.string})
