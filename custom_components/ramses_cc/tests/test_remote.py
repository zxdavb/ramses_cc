...
from homeassistant.const import ATTR_ENTITY_ID, CONF_PLATFORM, STATE_OFF, STATE_ON
...
async def _test_is_on(hass: HomeAssistant) -> None:
    """Test is_on."""
...
async def _test_send_command(hass: HomeAssistant) -> None:
    """Test send_command."""
...
async def _test_learn_command(hass: HomeAssistant) -> None:
    """Test learn_command."""
